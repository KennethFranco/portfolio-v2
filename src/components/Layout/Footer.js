...
const Footer = () => (
  <footer className="text-center justify-center font-abc py-9 bg-red3 text-cream text-xl">
    ...
    <a className="hover:text-gold" href="mailto:kennethlaurenzfranco@gmail.com">
