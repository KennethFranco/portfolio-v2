...
import { CreateEnvironmentTemplateInstallationProps, ValidateEnvironmentTemplateInstallationProps } from './entities/environment-template-installation';
export declare type ContentfulEnvironmentTemplateApi = ReturnType<typeof createEnvironmentTemplateApi>;
export declare function createEnvironmentTemplateApi(makeRequest: MakeRequest, organizationId: string): {
    ...
    } & ValidateEnvironmentTemplateInstallationProps) => Promise<import("./entities/environment-template-installation").EnvironmentTemplateValidationProps<import("./entities/environment-template-installation").ValidationFinding>>;
    /**
