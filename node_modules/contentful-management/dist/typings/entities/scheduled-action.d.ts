...
export declare type ScheduledActionPayloadProps = {
...
export declare type CreateUpdateScheduledActionProps = Pick<ScheduledActionProps, 'action' | 'entity' | 'environment' | 'scheduledFor' | 'payload'>;
export declare type ScheduledActionCollection = CursorPaginatedCollectionProp<ScheduledActionProps>;
